...
## Generated Reports (10 total)

The `scripts/gateway_evaluator_full.py` generates individual PDF evaluation reports:

| Model | PDF Report |
|-------|------------|
| Meta Llama 3.1 8B | [llama3-1-8b-evaluation.pdf](reports/model-evals/llama3-1-8b-evaluation.pdf) |
| Alibaba Qwen 2.5 7B | [qwen2-5-7b-evaluation.pdf](reports/model-evals/qwen2-5-7b-evaluation.pdf) |
| Microsoft Phi 3 Mini | [phi3-mini-evaluation.pdf](reports/model-evals/phi3-mini-evaluation.pdf) |
| GPT OSS 20B | [gpt-oss-20b-evaluation.pdf](reports/model-evals/gpt-oss-20b-evaluation.pdf) |
| Google Gemma 2 9B | [gemma2-9b-evaluation.pdf](reports/model-evals/gemma2-9b-evaluation.pdf) |
| Mistral 7B | [mistral-7b-evaluation.pdf](reports/model-evals/mistral-7b-evaluation.pdf) |
| BGE M3 Embedding | [bge-m3-latest-evaluation.pdf](reports/model-evals/bge-m3-latest-evaluation.pdf) |
| Mixedbread AI Embed Large | [mxbai-embed-large-latest-evaluation.pdf](reports/model-evals/mxbai-embed-large-latest-evaluation.pdf) |
| GPT OSS Latest | [gpt-oss-latest-evaluation.pdf](reports/model-evals/gpt-oss-latest-evaluation.pdf) |
| GPT OSS 20B Latest | [gptoss20b-latest-evaluation.pdf](reports/model-evals/gptoss20b-latest-evaluation.pdf) |

## Report Format

Each PDF report (approx. 2.4MB) includes:

- **Page 1:** Cover page with Wilson Eval3ngine logo, model name, date, run ID, and status
- **Page 2:** Executive Summary with metrics table (Avg Response Time, Prompt Success Rate, Total Tokens, Code Examples, Security Awareness)
- **Pages 3-7:** Individual prompt evaluation pages, one per test question, with full question text, response, and metrics

## Color Scheme

- Royal Blue (0.2, 0.4, 0.9): Title "Wilson Eval3ngine", Prompt N headers
- Dark Metallic Blue (0.1, 0.2, 0.5): Section headers, subtitle headings
- Yellow (0.9, 0.7, 0.2): Table headers, question box background, metadata table on cover

## How to Generate Reports

```bash
# Generate reports using mock data
python3 scripts/gateway_evaluator_full.py --mock

# Generate reports with live gateway data (requires 10.133.7.211 access)
...
**Platform:** Geezer Mekanix Agentic Engineering Platform, hosted by REDC2 Portal
